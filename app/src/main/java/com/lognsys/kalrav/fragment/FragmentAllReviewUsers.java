...
public class FragmentAllReviewUsers extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        View v = inflater.inflate(R.layout.fragment_all_reviews_users, container, false);
        vertical_recycler_view= (RecyclerView) v.findViewById(R.id.rvUsersReview);
