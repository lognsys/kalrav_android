...
public class AdmobActivity extends AppCompatActivity {
    ...
    private static final String ADMOB_AD_UNIT_ID = "ca-app-pub-2091012524875733/1750302207";
    private static final String ADMOB_APP_ID = "ca-app-pub-2091012524875733~1184042602";
    ...
    private void refreshAd(boolean requestAppInstallAds, boolean requestContentAds) {
        ...
        AdLoader adLoader = builder.withAdListener(new AdListener() {
            ...
            public void onAdFailedToLoad(int errorCode) {
                mRefresh.setEnabled(true);
                Toast.makeText(AdmobActivity.this, "Failed to load native ad: "
